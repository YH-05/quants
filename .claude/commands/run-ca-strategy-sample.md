...
- `research/ca_strategy_poc/workspace_dis_sample/batch_inputs/scoring_input_batch_*.json` が生成されること
...
指示:
  ...
  scoring_input.json パス:
    research/ca_strategy_poc/workspace_dis_sample/batch_inputs/scoring_input_batch_0.json

  workspace_dir:
    research/ca_strategy_poc/workspace_dis_sample

  出力先:
    research/ca_strategy_poc/workspace_dis_sample/phase2_output/{TICKER}/scored_batch_0.json
...
- scoring_input_batch_*.json: research/ca_strategy_poc/workspace_dis_sample/batch_inputs/
- scored_batch_*.json: research/ca_strategy_poc/workspace_dis_sample/phase2_output/{TICKER}/
