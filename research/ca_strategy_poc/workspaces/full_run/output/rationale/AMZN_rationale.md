...
- **Score**: 0.7
- **Rationale**: Sector rank 3, score 0.70

## Score Details

- **Aggregate Score**: 0.7000
- **Claim Count**: 5
...
- **Adjustments**:
  ...
  - KB2-T pattern_IV_structural_market_position: +10% (11 リージョンの構造的ポジション)
  - KB2-T pattern_III_capability_over_result: +5% (能力の説明)
...
- **Adjustments**:
  ...
  - KB2-T pattern_I_quantitative_differentiation: +10% (定量的証拠群)
  - KB2-T pattern_IV_structural_market_position: +5% (構造的ポジション)
...
- **Adjustments**:
  ...
  - KB2-T pattern_I_quantitative_differentiation: +10% (109 という定量化)
  - dogma rule11_industry_structure_fit: +5% (eコマース成長 × 物流インフラ規模の業界構造合致)
...
- **Adjustments**:
  ...
  - KB2-T pattern_IV_structural_market_position: +10% (ネットワーク効果による構造的ポジション)
  - KB2-T pattern_I_quantitative_differentiation: +5% (FBA 比率の定量化)
...
- **Adjustments**:
  ...
  - KB2-T pattern_G_unclear_vs_pure_competitor: -10% (Flipkart 等との比較なし)
  - KB2-T pattern_I_quantitative_differentiation: +5% (25M ASIN の定量化)
