...
| act-2026-03-18-001 | EDINET DB Proプラン検討 | 中 | pending |
...
| act-2026-03-19-002 | NAS再起動後Tailscale自動起動確認 | 中 | pending |
| act-2026-03-19-003 | UGOS FW更新後Tailscale永続化確認 | 中 | pending |
...
### 中優先
5. **NAS Tailscale検証**（act-2026-03-19-002, 003）: 次回NAS再起動時に確認
6. **EDINET Proプラン検討**（act-2026-03-18-001）: コスト対効果判断
