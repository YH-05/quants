...
- [ ] pyproject.toml に news_scraper 設定を追加
  - Issue: [#3617](https://github.com/YH-05/quants/issues/3617)
  - ステータス: todo
  - 見積もり: 0.25h
...
- [ ] 基盤ファイル作成（types, exceptions, session, async_core, py.typed, README）
  - Issue: [#3618](https://github.com/YH-05/quants/issues/3618)
  - ステータス: todo
  - 依存: #3617
  - 見積もり: 0.5h
...
- [ ] スクレイパー実装の移植（retry, cnbc, nasdaq, yfinance）
  - Issue: [#3619](https://github.com/YH-05/quants/issues/3619)
  - ステータス: todo
  - 依存: #3618
  - 見積もり: 1.5-2h
...
- [ ] 統合スクレイパーと CLI の移植（unified, async_unified, finance_news_collect）
  - Issue: [#3620](https://github.com/YH-05/quants/issues/3620)
  - ステータス: todo
  - 依存: #3619
  - 見積もり: 0.75h
...
- [ ] パッケージ統合（__init__.py, __main__.py）
  - Issue: [#3621](https://github.com/YH-05/quants/issues/3621)
  - ステータス: todo
  - 依存: #3620
  - 見積もり: 0.25h
...
- [ ] テストスイート作成 + make check-all
  - Issue: [#3622](https://github.com/YH-05/quants/issues/3622)
  - ステータス: todo
  - 依存: #3621
  - 見積もり: 1h
...
- [ ] CLAUDE.md 更新
  - Issue: [#3623](https://github.com/YH-05/quants/issues/3623)
  - ステータス: todo
  - 依存: #3621, #3622
  - 見積もり: 0.25h
