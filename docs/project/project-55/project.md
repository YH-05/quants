...
- [x] DuckDB upsert ロジックの移植（store_df / get_table_names）
  - Issue: [#3631](https://github.com/YH-05/quants/issues/3631)
  - ステータス: done
  - 見積もり: 1.5h

- [x] ProjectConfig frozen dataclass の作成
  - Issue: [#3632](https://github.com/YH-05/quants/issues/3632)
  - ステータス: done
  - 見積もり: 1h
...
- [x] Bloomberg 型定義・定数・エクスポートの追加
  - Issue: [#3633](https://github.com/YH-05/quants/issues/3633)
  - ステータス: done
  - 依存: Wave 1
  - 見積もり: 0.5h

- [x] Bloomberg _process_* プレースホルダ実装とテスト
  - Issue: [#3634](https://github.com/YH-05/quants/issues/3634)
  - ステータス: done
  - 依存: task-3
  - 見積もり: 2h

- [x] Bloomberg 新規メソッド追加・store_to_database DuckDB対応・norecursedirs 削除
  - Issue: [#3635](https://github.com/YH-05/quants/issues/3635)
  - ステータス: done
  - 依存: task-4
  - 見積もり: 2h
...
- [x] News Embedding 型定義・リーダー・レートリミッターの作成
  - Issue: [#3636](https://github.com/YH-05/quants/issues/3636)
  - ステータス: done
  - 見積もり: 1h

- [x] News Embedding エクストラクター・ChromaDB ストア・パイプラインの作成
  - Issue: [#3637](https://github.com/YH-05/quants/issues/3637)
  - ステータス: done
  - 依存: task-6
  - 見積もり: 1.5h

- [x] News Embedding CLI・エントリポイント・pyproject.toml 統合
  - Issue: [#3638](https://github.com/YH-05/quants/issues/3638)
  - ステータス: done
  - 依存: task-7
  - 見積もり: 1h
