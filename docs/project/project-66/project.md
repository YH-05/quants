...
- [ ] Step 0: 実API検証（curl 7本）
  - Issue: [#3732](https://github.com/YH-05/quants/issues/3732)
  - ステータス: todo
  - 見積もり: 0.5h
...
- [ ] データモデル層: types.py + テスト全面更新
  - Issue: [#3733](https://github.com/YH-05/quants/issues/3733)
  - ステータス: todo
  - 依存: #3732
  - 見積もり: 2h
...
- [ ] APIクライアント層: client.py + テスト更新
  - Issue: [#3734](https://github.com/YH-05/quants/issues/3734)
  - ステータス: todo
  - 依存: #3733
  - 見積もり: 2h
...
- [ ] ストレージ層: storage.py + constants.py + テスト更新
  - Issue: [#3735](https://github.com/YH-05/quants/issues/3735)
  - ステータス: todo
  - 依存: #3733
  - 見積もり: 3h
...
- [ ] 同期フロー層: syncer.py + テスト更新
  - Issue: [#3736](https://github.com/YH-05/quants/issues/3736)
  - ステータス: todo
  - 依存: #3734, #3735
  - 見積もり: 1h
...
- [ ] ドキュメント・エクスポート・PR作成
  - Issue: [#3737](https://github.com/YH-05/quants/issues/3737)
  - ステータス: todo
  - 依存: #3736
  - 見積もり: 1.5h
